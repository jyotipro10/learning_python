...
def initBoard(ttt):
    ...
    pygame.draw.line (background, (0,250,0), (100, 0), (100, 300), 2)
    pygame.draw.line (background, (0,250,0), (200, 0), (200, 300), 2)

    pygame.draw.line (background, (250,0,0), (0, 100), (300, 100), 2)
    pygame.draw.line (background, (250,0,0), (0, 200), (300, 200), 2)
...
def drawStatus (board):
    ...
    text = font.render(message, 1, (100, 20, 108))
...
def clickBoard(board):
    ...
    if ((grid[row][col] == "Player 1") or (grid[row][col] == "Player 2")):
        return
